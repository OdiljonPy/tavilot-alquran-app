...
mixin _$RegisterConfirmationState {
  ...
  int get isAllowed => throw _privateConstructorUsedError;
  ...
  int get confirmCodeCount => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      confirmCode: null == confirmCode
          ...
          : confirmCode // ignore: cast_nullable_to_non_nullable
              as String,
      confirmCodeCount: null == confirmCodeCount
          ? _value.confirmCodeCount
          : confirmCodeCount // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$RegisterConfirmationStateImpl extends _RegisterConfirmationState {
  const _$RegisterConfirmationStateImpl(
      ...
      this.confirmCode = '',
      this.confirmCodeCount = 2,
      this.otpKey,
      this.timerText = '00:60'})
      : super._();
  ...
  @override
  String toString() {
    return 'RegisterConfirmationState(isLoading: $isLoading, isSuccess: $isSuccess, isAllowed: $isAllowed, isTimeExpired: $isTimeExpired, isCodeError: $isCodeError, isConfirm: $isConfirm, confirmCode: $confirmCode, confirmCodeCount: $confirmCodeCount, otpKey: $otpKey, timerText: $timerText)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.confirmCodeCount, confirmCodeCount) ||
                other.confirmCodeCount == confirmCodeCount) &&
