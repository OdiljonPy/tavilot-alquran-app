...
/// @nodoc
mixin _$AboutState {
  bool get isAboutLoading => throw _privateConstructorUsedError;
...
abstract class $AboutStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isAboutLoading, About? about});
}
...
class _$AboutStateCopyWithImpl<$Res, $Val extends AboutState>
  ...
  @override
  $Res call({
    Object? isAboutLoading = null,
    Object? about = freezed,
  }) {
    return _then(_value.copyWith(
      isAboutLoading: null == isAboutLoading
          ? _value.isAboutLoading
          : isAboutLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      about: freezed == about
          ? _value.about
...
class _$AboutStateImpl extends _AboutState {
  const _$AboutStateImpl({this.isAboutLoading = false, this.about}) : super._();
  ...
  @override
  String toString() {
    return 'AboutState(isAboutLoading: $isAboutLoading, about: $about)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isAboutLoading, isAboutLoading) ||
                other.isAboutLoading == isAboutLoading) &&
            (identical(other.about, about) || other.about == about));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isAboutLoading, about);
...
abstract class _AboutState extends AboutState {
  const factory _AboutState({final bool isAboutLoading, final About? about}) =
      _$AboutStateImpl;
  const _AboutState._() : super._();

  @override
  bool get isAboutLoading;
  @override
  About? get about;
