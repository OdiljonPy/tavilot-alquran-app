  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Padding(
        //   padding: REdgeInsets.only(top: 60,left: 40,right: 40 ),
        //   child: Row(
        //     children: [
        //       Expanded(
        //           child: MainPostItem(onTap: (){}, icon: "assets/svg/book.svg", title: LocaleKeys.abuMansurMotrudiy.tr(),)),
        //       20.horizontalSpace,
        //       Expanded(
        //           child: ButtonEffect(
        //                                 onTap: () {
        ...
        //                   const Spacer(),
        //                   Text(
        //                     LocaleKeys.manuscriptAndComments.tr(),
        //                     style:
        //                     Style.interRegular(size: 24, color: Style.black),
        //                   )
        //                 ],
        ...
        //                   const Spacer(),
        //                   Text(
        //                     LocaleKeys.resourcesStudyGuides.tr(),
        //                     style:
        //                     Style.interRegular(size: 24, color: Style.black),
        //                   )
        //                 ],
        ...
        //                   const Spacer(),
        //                   Text(
        //                     LocaleKeys.rebuttalsToFanaticism.tr(),
        //                     style:
        //                     Style.interRegular(size: 24, color: Style.black),
        //                   )
        //                 ],
