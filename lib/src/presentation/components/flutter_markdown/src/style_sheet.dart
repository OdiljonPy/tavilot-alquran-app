...
class MarkdownStyleSheet {
  ...
  factory MarkdownStyleSheet.fromTheme(ThemeData theme) {
    ...
    return MarkdownStyleSheet(
      ...
      //todo
      arabicTextStyle: theme.textTheme.bodyMedium!.copyWith(
        fontFamily: 'Amiri',
  ...
  MarkdownStyleSheet copyWith({
    ...
    return MarkdownStyleSheet(
      ...
      arabicTextStyle: arabicTextStyle ?? this.arabicTextStyle,
  ...
  MarkdownStyleSheet merge(MarkdownStyleSheet? other) {
    ...
    return copyWith(
      ...
      arabicTextStyle: other.arabicTextStyle,
  ...
  bool operator ==(Object other) {
    ...
    return other is MarkdownStyleSheet &&
        ...
        other.arabicTextStyle == arabicTextStyle;
  }
